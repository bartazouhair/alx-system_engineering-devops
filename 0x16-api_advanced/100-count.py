...
def count_word_title(title, i, len_t, dict_words_unique):
    """Store repeating string in table"""
    if i >= len_t:
        return None
...
def count_words(subreddit, word_list):
    """Count number of time a word in word_list is name
    in hot articles subrredt"""
